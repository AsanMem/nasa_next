...
export default async function Page({ searchParams }: IProps) {
  ...
  return (
    <>
      <BackgroundImage src={"https://firebasestorage.googleapis.com/v0/b/nasa-odisey.appspot.com/o/media%2Fbg%2Fgreg-rakozy-oMpAz-DN-9I-unsplash.jpg?alt=media&token=6c2c6d96-9b8e-4db7-a0ac-c7534293e2fd"} className="fixed w-full h-full left-0 top-0 z-0 blur-sm" />
